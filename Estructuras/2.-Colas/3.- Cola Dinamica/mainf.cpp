...
//Constructor de la clase
	...
	////Asignamos los metodos de la lista doblemente enlazada con la lista 
...
{
	//Inicio del objeto de la clase que creamos
	CPrueba PD;
	int opc,e;
...
case 8:{
	...
	cout<<endl<<"Quiere salir?, presione 10 para salir, cualquier otro para no: ";
	cin>>opc;
	system("CLS");
